...
if __name__ == "__main__":
    ...
    prefix='combine_conv1d_lstm'#script will create dir called ./temp/${prefix} to store model,weight history and pred vs. true
    prefix='temp/'+prefix
    ...
    op=TimeDistributed(Conv1D(filters=1,kernel_size=6,padding='same'))(ip)
    op=layers.Reshape((4,22))(op)
